...
{   [SerializeField]
    ...
    void FixedUpdate()
    {
            ...
            if (Input.GetKey(KeyCode.W) && _camera.transform.position.x + moveForward < maxX)
            {
            ...
            if (Input.GetKey(KeyCode.S) && _camera.transform.position.x - moveForward > minX)
            {
                _camera.transform.position = new Vector3(_camera.transform.position.x - moveForward, _camera.transform.position.y, _camera.transform.position.z);
            }
            if (Input.GetKey(KeyCode.A) && _camera.transform.position.z + moveSide < maxY)
            {
            ...
            if (Input.GetKey(KeyCode.D) && _camera.transform.position.z - moveSide > minY)
            {
                _camera.transform.position = new Vector3(_camera.transform.position.x, _camera.transform.position.y, _camera.transform.position.z - moveSide);
            }
